...
const resources = {
  ...
  ky: {
    translation: {
      ...
      registerSuccessAndSendConfirmEmail: "Катталуу ийгиликтүү болду жана ырастоо шилтемеси сиздин электрондук почтаңызга жөнөтүлдү.",
  ...
  en: {
    translation: {
      ...
      registerSuccessAndSendConfirmEmail: "Registration was successful and a confirmation link has been sent to your email.",
